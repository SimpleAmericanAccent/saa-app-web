...
import {
  ...
  CollapsibleTrigger,
  CollapsibleContent,
} from "frontend/src/components/ui/collapsible";
...
export default function WLS() {
  ...
  // Initialize openSections with default true values
  ...
  const handleNavClick = (id) => {
    // Target the main content ScrollArea's viewport specifically
    const viewport = document.querySelector(
      '.wls-content [data-slot="scroll-area-viewport"]'
    );
    ...
    if (element && viewport) {
      ...
      const offset = elementRect.top - viewportRect.top + viewport.scrollTop;

      viewport.scrollTo({
        top: offset - navbarHeight, // 40px offset from top
        behavior: "smooth",
      });
    }
  };
  return (
    <div className="bg-background">
      <ResizablePanelGroup direction="horizontal">
        {/* Side Navigation */}
        <ResizablePanel defaultSize={isSmallScreen ? 30 : 10}>
            ...
            <div className="p-2">
              <ul className="">
                {headings.map((h1) => (
                  <Collapsible
                    key={h1.id}
                    open={openSections[h1.id]}
                    onOpenChange={(isOpen) =>
                      setOpenSections((prev) => ({ ...prev, [h1.id]: isOpen }))
                    }
                  >
                    <CollapsibleTrigger className="flex items-center gap-2 w-full hover:text-primary">
                      <ChevronDown
                        className={`h-4 w-4 transition-transform duration-200 ${
                          openSections[h1.id] ? "" : "-rotate-90"
                        }`}
                      />
                      <a
                        href={`#${h1.id}`}
        ...
        {/* Main Content */}
        <ResizablePanel>
          <ScrollArea className="wls-content h-[calc(100vh-var(--navbar-height))] flex-1 px-5 scroll-py-0">
            <h1 id="Vowels">Vowels</h1>
            <h2 id="FLEECE">FLEECE</h2>
            Spellings & Example Words:
            <ul>
              <li>
                e: he, she, me, we, be, the, these, concede, meme, theme,
                scheme, extreme, gene, scene, obese, compete, eve
              </li>
              <li>ee: bee, fee, free, knee, tee, see</li>
              <li>ea: sea, each, wheat, tear, eat, meat</li>
              <li>
                i: ski, visa, pizza, bistro, police, prestige, automobile,
                regime, machine, routine, cuisine, vaccine, unique
              </li>
              <li>
              ...
              <li>
                ie: lien, chief, field, piece, brief, yield, grief, thief,
                niece, series, belief, married, studied
              </li>
            ...
            <ul>
              ...
              <li>
                ey: monkey, turkey, hockey, donkey, valley, journey, money,
                honey, alley
              </li>
              <li>ie: cookie, movie, rookie, Barbie, brownie, beanie</li>
              <li>
                i: taxi, kiwi, deli, chili, corgi, sushi, khaki, safari,
                tsunami, martini, graffiti
              </li>
              <li>
            ...
            <ul>
              ...
              <li>
                ea: bread, head, dead, lead, read, spread, thread, instead
              </li>
            ...
            <ul>
              <li>
                am: am, dam, family, ham, jam, lamb, Ma&apos;am, ram, Sam,
              </li>
              <li>
                an: an, ban, band, can, can&apos;t, fan, grandma, hand, man,
                pan, ran, sand, analyze
              </li>
            </ul>
            <br />
            Audio: TBD
            ...
            <ul>
              ...
              <li>
                o: done, come, honey, none, won, money, some, stomach, son,
                month, Monday, front, wonderful, among, monkey, nothing, other,
                mother, brother, another, love, above, cover, government
              </li>
              <li>
            ...
            <ul>
              ...
              <li>
                ...
                sauce, taught, auto, daughter, glaucoma, trauma, haunted,
                author, cause, pause, applause, clause, nausea, menopause,
                caution
              </li>
              <li>
            ...
            <ul>
              <li>
                oi: oil, join, soil, coin, void, foil, boil, point, voice,
                joint, choice, toilet, invoice, hoist, moist, joist, rejoice
              </li>
              <li>
            ...
            <ul>
              <li>
                o: go, no, so, note, tote, wrote, vote, ago, pro, ego, only,
                also, most, both, home, open, those
              </li>
              <li>oh: oh, ohms</li>
            ...
            <ul>
              ...
              <li>
                ch: tech, echo, Bach, ache. mach, chaos, choir, chemical,
                chronic, stomach, scholar
              </li>
              <li>q: Qatar</li>
            ...
            <ul>
              ...
              <li>
                g: giraffe, gym, gentle, gender, gene, gel, gem, gin, germ,
                giant
              </li>
            ...
            <ul>
              <li>n: no, on, never</li>
              <li>
                nt (sometimes can be reduced to just n): into, interview,
                internet
              </li>
              ...
              <li>
                ...
                <ul>
                  <li>
                    ...
                    positions, and what varies is tongue tip contact. IPA is
                    TBD:
                    <ul>
                      <li>
                        [ɫ] - when syllable initial, tongue tip is required
                      </li>
                      <li>
                        [ɫ] - when syllable final, no tongue tip contact
                        required unless followed by a vowel
                      </li>
                    </ul>
                  </li>
                </ul>
            ...
            <ul>
              ...
              <li>
                (null): document, accuse, procure, million, volume, value,
                onion, union, opinion, Europe, eulogy
              </li>
              <li>j: fjord, Johan</li>
            </ul>
            <br />
