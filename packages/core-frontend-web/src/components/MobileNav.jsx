...
export function MobileNav() {
  ...
  return (
    <nav className="md:hidden min-h-[var(--navbar-height)] max-h-[var(--navbar-height)] sticky bg-background top-0 border-b z-50 px-4 flex items-center justify-between">
