  ...
  if (isPlaying) {
    ...
    if (filterF1 && filterF2 && filterF3) {
      ...
      filterF3.frequency.setValueAtTime(
        parseFloat(F3ValueSpan.textContent),
...
function startSound() {
  ...
  oscillator.frequency.setValueAtTime(
    parseFloat(pitchValueSpan.textContent),
    audioContext.currentTime
  ...
  filterF1.frequency.setValueAtTime(
    parseFloat(F1ValueSpan.textContent),
    audioContext.currentTime
  );
  ...
  filterF2.frequency.setValueAtTime(
    parseFloat(F2ValueSpan.textContent),
    audioContext.currentTime
  );
  ...
  gainNode.gain.setValueAtTime(
    parseFloat(volumeValueSpan.textContent),
    audioContext.currentTime
  ); // Volume control
