    ...
    <>
      ...
      <div id="content">
        ...
        <ul>
          ...
          <li>
            tt: butt, pretty, letter, attack, little, better, attract, atrophy,
            Otto
          </li>
        ...
        <ul>
          ...
          <li>Phonemic: /n/</li>
          <li>
            Phonetic: [n] but note it can float towards [ŋ] if followed by K or
            G
          </li>
        </ul>
        <h2>NG</h2>
        ...
        <ul>
          ...
          <li>
            Phonetic / Allophones:
            <ul>
              <li>[ŋ] - treat this as the default, as in &quot;singer&quot;</li>
              <li>
        ...
        <ul>
          <li>
            th: thin, think, with, three, breath, thing, theater, tooth, thick,
            author, Arthur, thermometer, thermostat
          </li>
        </ul>
        <br />
        Audio: TBD
        ...
        <ul>
          <li>
            th: this, that, the, they, though, smooth, weather, mother, brother,
            father, other, another, rather, together, whether, wither, bother,
            either, neither
          </li>
        </ul>
        <br />
        ...
        <ul>
          ...
          <li>
            ...
            <ul>
              <li>[z] - most common</li>
              <li>
                [z̥] or [s] - in some cases, such as &quot;dogs&quot; when phrase
                final or followed by a voiceless consonant it
              </li>
            </ul>
          </li>
        </ul>
