  ...
  return (
    <div className="p-4">
      ...
      <ul className="px-8 list-disc">
        <li>
          <a
            href="https://www.loom.com/share/4331ad9391924c219659dbbea578d9cd?sid=0089b33e-4f45-43a6-b7b4-ad8a0817adb0"
            target="_blank"
            rel="noopener noreferrer"
          >
            Some of my favorite exercises for accent training
          </a>{" "}
